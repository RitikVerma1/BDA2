#Datafile:https://github.com/Mounaki/Clustering/blob/master/grades_km_input.csv
source code:
...
grade_input=as.data.frame(read.csv("D:/msc-1/sem-2/BDA/prac all/StudentsPerformance.csv"))
